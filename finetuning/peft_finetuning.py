...
Uses Prefix Tuning method - works on both CPU and GPU
"""
...
def train_peft_finetuning(
    ...
    """
    PEFT fine-tuning function using Prefix Tuning for Sales dataset
    ...
    Args:
        ...
        num_virtual_tokens: Number of virtual tokens for prefix tuning
        max_steps: Maximum training steps (for quick testing)
    """
    
    print("=" * 60)
    print("PEFT FINE-TUNING (PREFIX TUNING) - SALES DATASET")
    print("=" * 60)
    ...
    print(f"\n3. Applying Prefix Tuning configuration...")
    ...
    # Train
    print("\n6. Starting PEFT (Prefix Tuning) fine-tuning...")
    print(f"   Technique: Prefix Tuning (PEFT)")
    ...
    # Save model
    print(f"\n7. Saving PEFT model to: {output_dir}")
