...
Uses Prefix Tuning - a true PEFT method (not LoRA)
"""
...
def train_h100_peft_finetuning(
    ...
    """
    H100 optimized PEFT fine-tuning using Prefix Tuning
    - Uses BF16 precision (optimal for H100)
    - Prefix Tuning: learns virtual tokens prepended to input
    - Very parameter efficient (~0.1% trainable)
    """
    
    print("=" * 60)
    print("H100 PEFT FINE-TUNING (PREFIX TUNING) - SALES DATASET")
    print("=" * 60)
    ...
    # Configure Prefix Tuning (true PEFT method)
    print(f"\n3. Configuring Prefix Tuning...")
    ...
    print(f"   - Prefix projection: True")
    ...
    # Train
    print("\n6. Starting H100 optimized Prefix Tuning...")
    print(f"   Technique: PEFT (Prefix Tuning)")
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("H100 PEFT (PREFIX TUNING) FINE-TUNING COMPLETED!")
        print("=" * 60)
        return output_dir
...
if __name__ == "__main__":
    try:
        ...
        print(f"\n[FAIL] H100 PEFT training failed: {e}")
        exit(1)
